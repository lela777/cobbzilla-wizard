...
public class ShardFindBy2FieldsTask<E extends Identifiable, D extends SingleShardDAO<E>> extends ShardFindAllTask<E, D> {
    ...
    public ShardFindBy2FieldsTask(D dao, Set<ShardTask<E, D, List<E>, List<E>>> tasks, String f1, Object v1, String f2, Object v2) {
        super(dao, tasks);
        this.f1 = f1;
        this.v1 = v1;
        this.f2 = f2;
