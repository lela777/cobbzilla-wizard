...
public abstract class FileUploadResource<FI extends AssetStorageInfo> {
    ...
    protected abstract boolean validateUpload(HttpContext context);
    protected abstract boolean validateDownload(HttpContext context, String uuid);
    protected abstract boolean validateDelete(HttpContext context, String uuid);
    ...
    public Response findDocuments(@Context HttpContext context) {
    ...
    @Produces(APPLICATION_JSON)
    public Response uploadDocument(@Context HttpContext context,
    ...
    @Consumes(APPLICATION_JSON)
    @Produces("*/*")
    public Response downloadDocument(@Context HttpContext context,
    ...
    @Consumes(APPLICATION_JSON)
    @Produces(APPLICATION_JSON)
    public Response deleteDocument(@Context HttpContext context,
                                   @PathParam("uuid") String uuid) {
