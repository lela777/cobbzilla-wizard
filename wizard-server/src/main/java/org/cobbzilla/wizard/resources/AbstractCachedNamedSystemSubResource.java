...
public abstract class AbstractCachedNamedSystemSubResource<R extends AbstractCachedSubResource,
                                                           E extends NamedIdentityBase>
        extends AbstractCachedNamedSubResource<R, E> {

    public boolean isAdmin(HttpContext ctx) {
